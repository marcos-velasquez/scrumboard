...
import { UpdateLastActivityScrumBoardUseCase } from './update-last-activity/update-last-activity-scrumboard.usecase';
...
export const updateLastActivityScrumBoardUseCase = new UpdateLastActivityScrumBoardUseCase(scrumBoardRepository);
